...
class GridstackFieldItem extends FieldItemBase {
   ...
   * {@inheritdoc}
   */
  public function __construct(DataDefinitionInterface $definition, $name, TypedDataInterface $parent, GridstackFieldHelperInterface $helper, Html $html) {
...
//    $defaults['row_setting'] = field_info_field_settings($field['type']);
    ...
    foreach (node_type_get_types() as $key => $type) {
      $form[$key] = [
        '#type'  => 'checkbox',
        '#title' => $this->html->escape($type->get('name')),
